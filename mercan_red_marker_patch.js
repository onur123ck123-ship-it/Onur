...
function reload(){try{if(window.loadVenues&&document.getElementById('map')&&getComputedStyle(document.getElementById('map')).display!=='none')loadVenues()}catch(e){}}
patch();setTimeout(function(){patch();reload()},700);setTimeout(reload,1800);setInterval(patch,1500);
})();